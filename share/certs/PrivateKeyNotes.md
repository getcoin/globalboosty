...
unlocked to sign the GlobalBoost-Qt.app bundle.
...
allowing somebody to distribute a GlobalBoost-Qt.app or globalboost-qt-setup.exe with a valid
...
that the globalboost-qt.exe file inside the installer had not been tampered with.
