...
http://gitorious.org/bitcoin/globalboostd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix GlobalBoost-Qt notifications under Growl 1.3.
Increase required age of GlobalBoost-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing GlobalBoost-Qt over it. (Windows)
