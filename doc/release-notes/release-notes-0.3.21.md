...
* Universal Plug and Play support.  Enable automatic opening of a port for incoming connections by running bitcoin or globalboostd with the - -upnp=1 command line switch or using the Options dialog box.
