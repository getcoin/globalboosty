GlobalBoost Core version 0.9.2 is now available from:
...
installer (on Windows) or just copy over /Applications/GlobalBoost-Qt (on Mac) or
globalboostd/globalboost-qt (on Linux).
...
- Lower paytxfee warning threshold from 0.25 BST to 0.01 BST
