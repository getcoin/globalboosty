...
- bin/32/globalboost-qt (GUI, 32-bit) or bin/32/globalboostd (headless, 32-bit)
- bin/64/globalboost-qt (GUI, 64-bit) or bin/64/globalboostd (headless, 64-bit)
...
Drag GlobalBoost-Qt to your applications folder, and then run GlobalBoost-Qt.
