...
/** Class encapsulating GlobalBoost Core startup and shutdown.
...
int main(int argc, char *argv[])
{
    ...
    /// 6. Determine availability of data directory and parse globalboost.conf
    ...
    try
    {
        ...
        WinShutdownMonitor::registerShutdownBlockReason(QObject::tr("GlobalBoost Core didn't yet exit safely..."), (HWND)app.getMainWinId());
#endif
        app.exec();
        app.requestShutdown();
        app.exec();
