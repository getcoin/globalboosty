    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GlobalBoost Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About GlobalBoost Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About GlobalBoost Core"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the GlobalBoost Core help message to get a list with possible Bitcoin command-line options"));
